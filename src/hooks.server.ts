...
import { resumeInterruptedSubmissions } from '$lib/server/submissions';

// Judging is in-process, so recover any jobs interrupted by a container restart.
void resumeInterruptedSubmissions();
